...
public class CrudAppTestSuite {
    ...
    private static final String BASE_URL = "https://Jola-Witaszak.github.io";
    ...
    private void sendTestTaskToTrello(String taskName) throws InterruptedException {
        ...
        driver.findElements(By.xpath("//form[@class=\"datatable__row\"]")).stream()
                ...
                .forEach(theForm -> {
                    ...
                    Select setBoard = new Select(selectBoard);
                    setBoard.selectByIndex(4);
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("wjola");
        driverTrello.findElement(By.id("password")).sendKeys("Z?a4,pqk&vb]t[X");
        WebElement el = driverTrello.findElement(By.id("login"));
        el.submit();

        Thread.sleep(4000);

        driverTrello.findElement(By.id("username")).sendKeys("jola-w@o2.pl");
