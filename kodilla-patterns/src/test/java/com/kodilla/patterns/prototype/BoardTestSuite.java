...
public class BoardTestSuite {
    ...
    void testToString() {
        ...
        //making a shallow clone of the object board
        ...
        //making a dep copy of object board
        ...
        board.getLists().remove(listDone);// po płytkim sklonowaniu zmiana w jednym obiekcie(np w liście, która jest
        // polem klonowanego obiektu) powoduje zmiany we wszystkich klonach i w obiekcie pierwotnym.
