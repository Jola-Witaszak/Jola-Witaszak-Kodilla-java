...
public class BookTestSuite {
    ...
    @Test
    void testGetListUsingIntStreamWithFunctionCount() {
        //Given
        BookDirectory bookDirectory = new BookDirectory();
        ...
        //Then
        long numberOfBokksPublicatedAfter2007 = IntStream.range(0, books.size())
                .filter(n ->books.get(n).getYearOfPublication() > 2007)
                .count();
        assertEquals(3, numberOfBokksPublicatedAfter2007);
    }
}
