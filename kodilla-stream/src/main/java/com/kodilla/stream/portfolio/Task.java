...
public final class Task {
    ...
    public boolean equals(Object o) {
        ...
        if (!getAssignedUser().equals(task.getAssignedUser())) return false;
        if (!getCreator().equals(task.getCreator())) return false;
        if (!getCreated().equals(task.getCreated())) return false;
        return getDeadline().equals(task.getDeadline());
    }
}
